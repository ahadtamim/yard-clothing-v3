...
// This matches the structure of your Category setup in the Admin Panel
          ...
          <div className="absolute top-full right-0 bg-white text-black min-w-[300px] shadow-2xl flex flex-col border-l border-gray-100">
            {navigationData.map((parent) => (
              <div key={parent.slug} className="border-b border-gray-50">
                <button 
                  onClick={() => setActiveParent(activeParent === parent.slug ? null : parent.slug)}
